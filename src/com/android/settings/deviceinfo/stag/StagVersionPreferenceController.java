...
public class StagVersionPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_STAG_VERSION,
                mContext.getString(R.string.stag_version_default));
    }
}
